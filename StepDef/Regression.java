...
public class Regression extends CATSCucumberConfig {
    ...
    public void verify_user_navigate_to_ride_and_attraction_detail_page() throws Throwable {
		...
		case("YWW"):
			catsAction.pageLoadWait();
		    Thread.sleep(3000);
            catsAction.verifyElementPresent(CustomRules.locatorPresentInSite(website+".Header.RideMenutiles", this.ormData));
	...
	public void user_clicks_on_main_menu_explore_item_and_select_rides_and_slide() throws Throwable
	{
		Thread.sleep(5000);
		catsAction.hoverNClickSubItem(CustomRules.locatorPresentInSite(website + ".Header.Explore",this.ormData),"Rides & Attractions");
	}

	@When("^User clicks on main Menu explore item and select shopping$")
	public void user_clicks_on_main_menu_explore_item_and_select_shopping() throws Throwable 
	{
		catsAction.hoverNClickSubItem(CustomRules.locatorPresentInSite(website + ".Header.Explore",this.ormData),"Shopping");
