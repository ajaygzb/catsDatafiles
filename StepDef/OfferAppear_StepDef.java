...
public class OfferAppear_StepDef  extends  CATSCucumberConfig{
	...
	@Before()
	  ...
	  @Then("^User able to see offer imgs below$")
	    public void user_able_to_see_offer_imgs_below() throws Throwable 
	  {
		  
		  catsAction.verifyElementPresent(CustomRules.locatorPresentInSite(website+".Home.OfferCard",this.ormData));  
}}