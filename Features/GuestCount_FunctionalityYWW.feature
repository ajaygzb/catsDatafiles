...
Scenario: YPS3962 Verify that for GENERAL ADMISSION tab maximum count a user can select for a particular ticket is 14 after that counter will be disabled
...
Scenario: YPS5736 Verify the changes for the visibility of the Quantity in the Mini cart for purchase journey 
...
Scenario: YPS8547 Verify that Loggedin user should be able to update cart from Cart Summary section on Payment page 
